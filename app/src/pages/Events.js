        ...
        <View style={{width: Dimensions.get('window').width / 1.28}}>
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            {props.data.speakers.length < 2 ? (
              <Link
                text={props.data.speakers[0].name}
                url={props.data.speakers[0].twitter}
              ...
              <View style={{flexDirection: 'row'}}>
                ...
                <Link
                  text={props.data.speakers[1].name}
                  url={props.data.speakers[1].twitter}
                  style={{color: '#8a8a8a', fontWeight: 'bold'}}
                />
              </View>
            )}
    ...
    <ScrollView style={{flex: 1}}>
      <SafeAreaView style={styles.main}>
        <View style={styles.box}>
          <Text style={styles.boxHeader}>Events Page</Text>
          <Text>
            You can find all the events organized by{' '}
            <Link
              text={'findmentor.network'}
